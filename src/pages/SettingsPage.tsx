          ...
          <div className="px-6 py-4">
            {userProfile?.awAddressCode ? (
              ...
              <div className="p-4 bg-amber-50 rounded-2xl border border-amber-100">
                <p className="font-black text-amber-800 text-[12px] mb-1"><BruIcons.MapPin size={10}/> Pas encore d'adresse numérique</p>
        ...
        {currentUser?.uid === ((import.meta as any).env?.VITE_ADMIN_UID || '__NONE__') && (
          <div className="px-2 mb-6">
            <button onClick={() => onNavigate('admin')}
              ...
              <BruIcons.Settings size={14}/> Administration Brumerie
            </button>
          </div>
        )}
